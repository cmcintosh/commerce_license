...
/**
 * Provides the form for adding license attribute translations.
 */
class LicenseAttributeTranslationAddForm extends ConfigTranslationAddForm {
  ...
  /**
   * Constructs a new LicenseAttributeTranslationAddForm object.
   *
