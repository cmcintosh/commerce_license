...
/**
 * Provides the form for editing license attribute translations.
 */
class LicenseAttributeTranslationEditForm extends ConfigTranslationEditForm {

  use LicenseAttributeTranslationFormTrait;
  ...
  /**
   * Constructs a new LicenseAttributeTranslationEditForm object.
   *
