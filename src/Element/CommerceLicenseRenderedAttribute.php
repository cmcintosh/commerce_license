 ...
 *   '#type' => 'commerce_license_rendered_attribute',
 ...
 * @endcode
 *
 * @FormElement("commerce_license_rendered_attribute")
 */
class CommerceLicenseRenderedAttribute extends Radios {
  ...
  public static function processRadios(&$element, FormStateInterface $form_state, &$complete_form) {
    if (count($element['#options']) > 0) {
      $storage = \Drupal::entityTypeManager()->getStorage('commerce_license_attribute_value');
      $view_builder = \Drupal::entityTypeManager()->getViewBuilder('commerce_license_attribute_value');
      ...
      foreach ($element['#options'] as $key => $choice) {
        ...
        if (isset($element['#default_value']) && $element['#default_value'] == $key) {
          $attributes['class'][] = 'license--rendered-attribute__selected';
        }
    ...
    $element['#attached']['library'][] = 'commerce_license/rendered-attributes';
    $element['#attributes']['class'][] = 'license--rendered-attribute';
