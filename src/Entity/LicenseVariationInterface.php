 ...
 */
interface LicenseVariationInterface extends PurchasableEntityInterface, EntityChangedInterface, EntityOwnerInterface {
   ...
   *
   * @return \Drupal\commerce_license\Entity\ProductAttributeValueInterface[]
   ...
   *   The field name.
   *
   * @return \Drupal\commerce_license\Entity\ProductAttributeValueInterface|null
